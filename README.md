# Functional Python [![](https://github.com/epaisano/functional-python/workflows/tests/badge.svg)](https://github.com/epaisano/functional-python/actions?query=workflow%3Atests)
